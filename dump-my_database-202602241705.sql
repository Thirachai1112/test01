...
INSERT INTO `borrowing_files` VALUES (10,58,'à¹à¸­à¸à¸¢à¹à¸²à¸¢à¸à¸£à¸±à¸à¸¢à¹à¸ªà¸´à¸ hp à¸.8-2560 à¸à¸à¸ª.à¸à¸à¸¥ 514760.pdf','/uploads/borrowing/22cd62da-193c-4de6-bdd8-f050ac08da11.pdf','application/pdf','2026-02-09 08:48:13'),(11,59,'à¹à¸­à¸à¸¢à¹à¸²à¸¢à¸à¸£à¸±à¸à¸¢à¹à¸ªà¸´à¸ hp à¸.8-2560 à¸à¸à¸ª.à¸à¸à¸¥ 514760.pdf','/uploads/borrowing/51584bd1-735b-43d0-a660-77591e71d15e.pdf','application/pdf','2026-02-11 02:13:11');
...
INSERT INTO `borrowing_logs` VALUES (46,30,190,'2026-02-04 05:25:53',NULL,'ยืมผ่านระบบ','switc ไม่สามารถใช้งานได้เลยต้องยืมจาก ผคข.กดส.ฉ.2 ใช้งาน ชั่วคราว',NULL),(50,34,195,'2026-02-06 03:36:57',NULL,'ยืมผ่านระบบ','ห้องประชุม มาลีรัก',NULL),(58,40,206,'2026-02-09 08:48:13',NULL,'ยืมผ่านระบบ','จัดให้คู่กับคอม บ.8/2560',NULL),(59,40,207,'2026-02-11 02:13:11',NULL,'ยืมผ่านระบบ',' จัดให้คู่กับคอม บ.8/2560',NULL),(64,44,230,'2026-02-17 03:11:24',NULL,'ยืมผ่านระบบ','นำไปต่อใช้งานที่ ชั้น 3 กบฟ.',NULL);
...
INSERT INTO `item_repair` VALUES (3,243,238,'2026-02-24 08:44:31'),(4,243,238,'2026-02-24 09:23:02');
...
CREATE TABLE `items` (
  ...
  `status` enum('Available','Borrowed','Maintenance','Broken','Scrapped') NOT NULL,
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE `repair` (
  ...
  `status` enum('Pending','In Progress','Fixed','Unfixable') DEFAULT 'Pending',
  ...
  `Procedure` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
...
-- Dump completed on 2026-02-24 17:05:41
