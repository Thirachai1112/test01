...
CREATE TABLE `items` (
  ...
  `status` enum('Available','Borrowed','Maintenance','Broken') DEFAULT 'Available',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
...
INSERT INTO `repair` VALUES (30,'HP รุ่น ProDesk 600 G2 MT','บ.8/2560','SGH708RCXT','532260756-0','ผมต.กฟส.ตผ.','ฮาร์ดดิสชำรุด','Fixed','/uploads/repairs/3243a5b2-f7a4-4f92-9488-7397251577c6.pdf',NULL,200,'2026-02-11 02:31:50','2026-02-11 03:48:57',' นายสมมิตร ลิ้มจิตรกร','333241','	06-1879-1692'),(35,'กหกห','กหก','หกห','กหก','หกหหก','หกหก','Pending','/uploads/repairs/d16cf9e7-af40-460c-a513-76f2ae649439.pdf',NULL,202,'2026-02-11 06:33:04','2026-02-11 06:33:04','หกหก','หกห','กหก'),(36,'sdsd','dsds','sds','dsds','sds','dsdsdsd','Pending','/uploads/repairs/924cca71-95bb-4e8b-9f72-9bc46b7d7895.pdf',NULL,202,'2026-02-11 06:46:44','2026-02-11 06:46:44','dsd','sds','dsd');
...
CREATE TABLE `repairs` (
  ...
  PRIMARY KEY (`repair_id`),
  KEY `item_id` (`item_id`),
  CONSTRAINT `repairs_ibfk_1` FOREIGN KEY (`item_id`) REFERENCES `items` (`item_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2026-02-11 14:05:53
